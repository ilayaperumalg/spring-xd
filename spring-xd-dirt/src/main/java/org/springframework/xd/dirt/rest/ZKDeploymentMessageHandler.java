 ...
 */
public class ZKDeploymentMessageHandler implements DeploymentMessageHandler {

	private final DistributedQueue<DeploymentMessage> distributedQueue;

	public ZKDeploymentMessageHandler(DistributedQueue<DeploymentMessage> distributedQueue) {
