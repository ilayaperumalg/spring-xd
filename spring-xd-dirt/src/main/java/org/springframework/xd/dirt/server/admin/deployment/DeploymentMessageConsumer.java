...
public class DeploymentMessageConsumer implements QueueConsumer<DeploymentMessage> {
	...
	// for testing only
	public synchronized void consumeMessage(DeploymentMessage message, ZKStreamDeployer streamDeployer, ZKJobDeployer jobDeployer) throws Exception {
	 ...
	 */
	@Override
	public synchronized void consumeMessage(DeploymentMessage deploymentMessage) throws Exception {
