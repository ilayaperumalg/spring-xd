...
public class ContainerListener implements PathChildrenCacheListener {
	 ...
	 */
	public ContainerListener(ZKDeploymentUtil zkDeploymentUtil,
		...
		this.containerMatchingModuleRedeployer = new ContainerMatchingModuleRedeployer(zkDeploymentUtil,
				streamDeployments, jobDeployments, moduleDeploymentRequests);
		this.departingContainerModuleRedeployer = new DepartingContainerModuleRedeployer(zkDeploymentUtil,
