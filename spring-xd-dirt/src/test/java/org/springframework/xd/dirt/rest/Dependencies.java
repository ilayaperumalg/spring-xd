...
import org.springframework.xd.dirt.server.admin.deployment.DeploymentMessageConsumer;
...
public class Dependencies {
	...
	@Bean
	public DeploymentMessageProducer DeploymentMessageProducer() {
		return new DeploymentMessageProducer() {
